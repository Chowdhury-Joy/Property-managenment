<x-layouts.public title="Home">
    ...
    <section class="bg-blue-900 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <a href="#rental-analysis" class="inline-block bg-white text-blue-900 px-8 py-3 rounded-md font-bold hover:bg-gray-100 transition">
    ...
    <section class="py-16 max-w-7xl mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8">
            <div class="p-6 bg-white rounded-lg shadow-sm">
                <div class="w-12 h-12 bg-blue-100 text-blue-900 rounded-full flex items-center justify-center mb-4 font-bold text-xl">1</div>
            ...
            <div class="p-6 bg-white rounded-lg shadow-sm">
                <div class="w-12 h-12 bg-blue-100 text-blue-900 rounded-full flex items-center justify-center mb-4 font-bold text-xl">2</div>
            ...
            <div class="p-6 bg-white rounded-lg shadow-sm">
                <div class="w-12 h-12 bg-blue-100 text-blue-900 rounded-full flex items-center justify-center mb-4 font-bold text-xl">3</div>
